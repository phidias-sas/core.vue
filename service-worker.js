'use strict';
importScripts("./static/localforage.min.js");

var db = null;

self.addEventListener('push', function(event) {

	localforage.getItem('app:core')
		.then(app => {

			fetch(app.endpoint + '/post/notification/unread?destination=' + app.pushToken, {
			...
			.then(stubs => {
				...
				*/
				clients.matchAll({
					...
					var displayNotification = stub.post.author.id != app.user.id;
