			...
			<div class="phi-page-toolbar" :class="{_hidden: tpl.toolbarIsHidden}">
				...
				<div class="phi-tooltip">
					...
					<ul class="phi-menu _texture-paper">
						...
						<li @click="move('feed')" :disabled="!feed.count('selected')">restaurar</li>
...
export default {
	...
	data() {
		return {
			moment,
			folder: {},
			feed: app.api.collection(`/people/${app.user.id}/posts/archive`),
			tpl: {
	...
	beforeRouteEnter(to, from, next) {
		var feed = app.api.collection(`/people/${app.user.id}/posts/archive`);
